    ...
    _initFallbackSpeechRecognition() {
      ...
      this.fallbackSpeechRecognition.onresult = (event) => {
        ...
        if (heard) {
          ...
          if (finalStr.trim()) {
            this._accumulatedUserSpeech = (this._accumulatedUserSpeech ? this._accumulatedUserSpeech + ' ' : '') + finalStr.trim();
            console.log('[VoiceAssistant STT] Accumulated speech:', this._accumulatedUserSpeech);
